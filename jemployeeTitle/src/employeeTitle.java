...
public class employeeTitle extends JApplet implements ActionListener{
...
String nm[]= {"James", "Chris","Shaun","Robert","Nicole"};

String titl[]=
{"Programmer", "Software Engineer", "CEO","Business Analyst","Secretary"};
